(function() {
	...
	/** @ngInject */
	function ProfileController(Storage, SideNavFactory, Datetime, DataService, restUrl, Message, $auth) {
		var vm = this;
		var confApp = $auth.getPayload().configuracion;
		vm.flagEditarCuenta =  confApp.edicion_cuenta;
		vm.flagEditarContrasenia = confApp.edicion_contrasena;
		vm.flagEditarTipoNotificacionesCorreo = confApp.habilitar_correo;
		vm.flagEditarTipoNotificacionesSms = confApp.habilitar_sms;
