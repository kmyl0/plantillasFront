...
Formatter = (function(superClass) {
  ...
  Formatter.prototype._init = function() {//mod-for-jl
    this.editor = this._module;
    this._allowedTags = $.merge(['br', 'span', 'a', 'img',' strong', 'strike', 'u', 'p', 'ul', 'ol', 'li', 'blockquote', 'pre', 'code', 'h1', 'h2', 'h3', 'h4', 'hr'], this.opts.allowedTags);
...
OrderListStyleButton = (function(superClass) { //mod-for-jl
  ...
  OrderListStyleButton.prototype.command = function(param) {
    var $ol, type;
    type = {
        'listDisc': 'disc',
        'listCircle': 'circle',
    ...
    while(!$ol.is('ol')){
        $ol = $ol.parent();
        if($ol.is('div.simditor-body')) return;
    }
