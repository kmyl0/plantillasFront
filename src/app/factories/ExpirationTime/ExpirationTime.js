(function() {
    ...
    angular
    .module('app')
    .factory('ExpirationTime', ['Storage', 'Message', '$interval', '$auth', '$location', '$mdDialog', 'DataService', 'restUrl', 'timeAutoSave', ExpirationTimeFactory]);

    /** @ngInject */
    function ExpirationTimeFactory(Storage, Message, $interval, $auth, $location, $mdDialog, DataService, restUrl, timeAutoSave) {
        ...
        */
        ...
        var fac = factory;
        var tiempo_autosave_miliseconds = (timeAutoSave||10)*60*1000; // la funcion interval se activara por defecto cada 10 minutos--> 10*60 = 600, tiempo en miliseconds 600*1000=600000
        return factory;
