...
/** @ngInject */
function DocumentoFactory(DataService, restUrl, backUrl, Datetime, UtilFormly, Modal, $window, $location, Storage) {
    ...
    */
    function showPdfId(id_documento, sw_url) {
        ...
        .then(function (respuesta) {
            showPdf(respuesta.datos.plantilla, respuesta.datos.plantilla_valor, respuesta.datos.nombre, sw_url);
        });
    }
    ...
    */
    function showPdf(plantilla, plantilla_valor, nombre, sw_url) {
            ...
            if(abrirDialogPDF){
                ...
                .then(function (respuestaPdf) {
                    ...
                    var config = {
                        ...
                        controller: ['data', '$scope', '$mdDialog', DialogPDFController]
                    }
                    Modal.show(config);
                })
            }else {
    ...
    */
    function DialogPDFController(data, $scope, $mdDialog){
        var vmd = $scope;
        vmd.data={};
        vmd.data.html=data.html;
        vmd.data.pdf=data.pdf;
        vmd.data.flag_html=data.esDispositivoMovil;
